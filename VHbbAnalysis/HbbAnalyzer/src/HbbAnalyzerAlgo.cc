...
HbbAnalyzerAlgo::produce( fwlite::Event & ev,VHbbEvent& vhbbevent_, VHbbEventAuxInfo& vhbbeventauxinfo_ ){
  ...
  */
  ...
  rho25Handle.getByLabel(iEvent,"kt6PFJets25", "rho");   
  auxInfo->puInfo.rho25 = *rho25Handle;
  fwlite::Handle<double> rho25HandleIso;
  rho25HandleIso.getByLabel(iEvent,"kt6PFJetsForIsolation", "rho");   
  auxInfo->puInfo.rho25Iso = *rho25HandleIso;
 
  fwlite::Handle<double> rhoNeutralHandle;
  rhoNeutralHandle.getByLabel(iEvent,"kt6PFJetsCentralNeutral", "rho");   
...
BTagSFContainer btagSFs;
  ...
  */
  ...
  for(std::vector<pat::Jet>::const_iterator jet_iter = simplejets2.begin(); jet_iter!=simplejets2.end(); ++jet_iter){
    ...
    /* TOM SHOULD NOT BE NEEDED IN THIS FORM
  ...
  */
  ...
  /* TOM SHOULD BE ALREADY CORRECTED  
// type 1 corr met
    edm::Handle<std::vector<reco::MET> > pfmetType1corrHandle;
  pfmetType1corrHandle.getByLabel(iEvent,"patType1CorrectedPFMet");
  std::vector<reco::MET> pfmetsType1corr = *pfmetType1corrHandle;
...
*/
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetElectronEnDownHandle;
  patType1CorrectedPFMetElectronEnDownHandle.getByLabel(iEvent,"patType1CorrectedPFMetElectronEnDown");
  std::vector<reco::MET> patType1CorrectedPFMetsElectronEnDown = *patType1CorrectedPFMetElectronEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetElectronEnUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetElectronEnUp",patType1CorrectedPFMetElectronEnUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsElectronEnUp = *patType1CorrectedPFMetElectronEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetMuonEnDownHandle;
  iEvent.getByLabel("patType1CorrectedPFMetMuonEnDown",patType1CorrectedPFMetMuonEnDownHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsMuonEnDown = *patType1CorrectedPFMetMuonEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetMuonEnUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetMuonEnUp",patType1CorrectedPFMetMuonEnUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsMuonEnUp = *patType1CorrectedPFMetMuonEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetTauEnDownHandle;
  iEvent.getByLabel("patType1CorrectedPFMetTauEnDown",patType1CorrectedPFMetTauEnDownHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsTauEnDown = *patType1CorrectedPFMetTauEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetTauEnUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetTauEnUp",patType1CorrectedPFMetTauEnUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsTauEnUp = *patType1CorrectedPFMetTauEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetJetEnDownHandle;
  iEvent.getByLabel("patType1CorrectedPFMetJetEnDown",patType1CorrectedPFMetJetEnDownHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsJetEnDown = *patType1CorrectedPFMetJetEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetJetEnUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetJetEnUp",patType1CorrectedPFMetJetEnUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsJetEnUp = *patType1CorrectedPFMetJetEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetJetResDownHandle;
  iEvent.getByLabel("patType1CorrectedPFMetJetResDown",patType1CorrectedPFMetJetResDownHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsJetResDown = *patType1CorrectedPFMetJetResDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetJetResUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetJetResUp",patType1CorrectedPFMetJetResUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsJetResUp = *patType1CorrectedPFMetJetResUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetUnclusteredEnDownHandle;
  iEvent.getByLabel("patType1CorrectedPFMetUnclusteredEnDown",patType1CorrectedPFMetUnclusteredEnDownHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsUnclusteredEnDown = *patType1CorrectedPFMetUnclusteredEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1CorrectedPFMetUnclusteredEnUpHandle;
  iEvent.getByLabel("patType1CorrectedPFMetUnclusteredEnUp",patType1CorrectedPFMetUnclusteredEnUpHandle);
  std::vector<reco::MET> patType1CorrectedPFMetsUnclusteredEnUp = *patType1CorrectedPFMetUnclusteredEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetElectronEnDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetElectronEnDown",patType1p2CorrectedPFMetElectronEnDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsElectronEnDown = *patType1p2CorrectedPFMetElectronEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetElectronEnUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetElectronEnUp",patType1p2CorrectedPFMetElectronEnUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsElectronEnUp = *patType1p2CorrectedPFMetElectronEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetMuonEnDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetMuonEnDown",patType1p2CorrectedPFMetMuonEnDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsMuonEnDown = *patType1p2CorrectedPFMetMuonEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetMuonEnUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetMuonEnUp",patType1p2CorrectedPFMetMuonEnUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsMuonEnUp = *patType1p2CorrectedPFMetMuonEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetTauEnDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetTauEnDown",patType1p2CorrectedPFMetTauEnDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsTauEnDown = *patType1p2CorrectedPFMetTauEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetTauEnUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetTauEnUp",patType1p2CorrectedPFMetTauEnUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsTauEnUp = *patType1p2CorrectedPFMetTauEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetJetEnDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetJetEnDown",patType1p2CorrectedPFMetJetEnDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsJetEnDown = *patType1p2CorrectedPFMetJetEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetJetEnUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetJetEnUp",patType1p2CorrectedPFMetJetEnUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsJetEnUp = *patType1p2CorrectedPFMetJetEnUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetJetResDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetJetResDown",patType1p2CorrectedPFMetJetResDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsJetResDown = *patType1p2CorrectedPFMetJetResDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetJetResUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetJetResUp",patType1p2CorrectedPFMetJetResUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsJetResUp = *patType1p2CorrectedPFMetJetResUpHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetUnclusteredEnDownHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetUnclusteredEnDown",patType1p2CorrectedPFMetUnclusteredEnDownHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsUnclusteredEnDown = *patType1p2CorrectedPFMetUnclusteredEnDownHandle;
  ...
  edm::Handle<std::vector<reco::MET> > patType1p2CorrectedPFMetUnclusteredEnUpHandle;
  iEvent.getByLabel("patType1p2CorrectedPFMetUnclusteredEnUp",patType1p2CorrectedPFMetUnclusteredEnUpHandle);
  std::vector<reco::MET> patType1p2CorrectedPFMetsUnclusteredEnUp = *patType1p2CorrectedPFMetUnclusteredEnUpHandle;
...
/* 2012 ELEID*/
  ...
  */
  ...
  // TOM   ef.fMVAVar_R9              =  lazyTools.e3x3(*(ele.superCluster()->seed())) / ele.superCluster()->rawEnergy();
...
void HbbAnalyzerAlgo ::fillSimpleJet (VHbbEvent::SimpleJet& sj, std::vector<pat::Jet>::const_iterator jet_iter){
    ...
    if (jet_iter->isPFJet() == true) {
      ...
      // TOM      sj.nConstituents = jet_iter->getPFConstituents().size();
